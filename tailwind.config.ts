...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        "contactBg" : "url('https://images.unsplash.com/photo-1551298370-9d3d53740c72?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"
